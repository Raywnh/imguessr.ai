  ...
  return (
      ...
      {pages == 0? <div className="row-padding padding-64 container">
          <div className="content">
            <div className="twothird">
              ...
              <p className="text-grey">
                Welcome to IMGUESSR.IO, a game that utilizes DALL-E 2 By OpenAI to generate random images for you to guess.
        ...
        <footer className="container padding-64 center opacity">
          <p>
            Made by <a href="https://github.com/rayzhou4" target="_blank">Ray Z</a> · <a href="https://github.com/Raywnh" target="_blank">Ray H</a> · <a href="https://github.com/migies12"  target="_blank">Miguel M</a> · <a href="https://github.com/AndyJLi0"  target="_blank">Andy L</a>
          </p>
        </footer>
      </div>:<Game></Game>}
      </div>
